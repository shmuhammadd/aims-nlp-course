...
|---------|---------------------------------|----------------------|-------------------------------------|
| **1**   | Introduction to NLP and LLMs    |    [Slide](https://github.com/shmuhammadd/aims-nlp-course/blob/main/slides/01_NLP_Lecture1..pdf)        | 1. [NLP Survey (Cambria & White)](https://arxiv.org/pdf/1708.05148) <br> 2. [AfricaNLP Overview (Adelani et al.)](https://arxiv.org/pdf/2509.25477)          |
| **2**   | How Language Modelling Started (N-grams) | [Slide](https://github.com/shmuhammadd/aims-nlp-course/blob/main/slides/02_NLP_Lecture2.pdf) <br><br> [Practical](https://colab.research.google.com/github/shmuhammadd/aims-nlp-course/blob/main/practicals/ngram_language_models_class.ipynb)
