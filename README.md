...
| **4**   | Word Vectors                              | [Slide](https://github.com/shmuhammadd/aims-nlp-course/blob/main/slides/04_NLP_Lecture.pdf)                                                                                                                                                                                                          | 1. Mikolov et al. (2013) — [Efficient Estimation of Word Representations](https://arxiv.org/pdf/1301.3781) <br> 2. Mikolov et al. (2013) — [Linguistic Regularities in Continuous Space Word Representations](https://arxiv.org/pdf/1310.4546) |
