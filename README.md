...
|---------|---------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| **1**   | Introduction to NLP and LLMs <br> [Slide](https://github.com/shmuhammadd/aims-nlp-course/blob/main/slides/01_NLP_Lecture1..pdf)               | 1. [NLP Survey (Cambria & White)](https://arxiv.org/pdf/1708.05148) <br> 2. [AfricaNLP Overview (Tadesse et al.)](https://arxiv.org/pdf/2509.25477)                         |          |
